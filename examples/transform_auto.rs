use std::io::Cursor;
use prk_async_dataflow::{AsyncJsonParser, DataConnector, FeatureTransformer, HttpConfig, HttpConnector, ParserConfig};
...
async fn main() {
    ...
    let parser = AsyncJsonParser::with_config(reader, ParserConfig {
        batch_size: 5,
